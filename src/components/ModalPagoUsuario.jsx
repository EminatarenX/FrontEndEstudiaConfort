...
export default function ModalPagoUsuario({ setModal, monto, id_habitacion, id_creador}) {
  const {cargando} = useEstudiantes()

  

  return (
    <div className="animate-entrada fixed h-full w-full flex items-center justify-center z-10 flex-col 
