  ...
  return (
    <>  
      <aside className={`lg:hidden fixed flex flex-col ${aside? 'right-0':' -right-[400px]'} bg-slate-950 px-32 gap-10 h-full pt-20 transition-all duration-700 ease  z-10`}>
        <Link to='/dashboard' className="text-white text-xl">Estudia<span className="text-sky-400">Confort</span></Link>
      ...
      <Link to='/dashboard' className="text-4xl text-white  animate-entrada  ">
