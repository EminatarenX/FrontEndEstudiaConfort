...
export default function Habitacion({foto,direccion, estado, ciudad,id}) {
  ...
  return (
    <div onClick={()=> navigate(`/dashboard/habitacion/${id}`)}  className="flex flex-col justify-center shadow border rounded-xl cursor-pointer hover:scale-105 transition-all">
