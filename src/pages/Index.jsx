    ...
    <main className="bg-degradado">
      ...
      <section className="flex flex-col lg:flex-row xl:pt-20 justify-between mx-10 xl:mx-40 items-center">
        <article className="flex flex-col  xl:items-start gap-2 xl:gap-0">
            <span className="bg-indigo-950 border-white shadow p-2 text-white font-semibold rounded w-48 text-center">Estudia cómodamente</span>
            <h1 className="text-white text-6xl font-bold mt-5">Estudia Confort</h1>
            <p className="text-white mt-5 text-justify lg:w-[500px]">Bienvenido. con esta aplicación tendrás acceso a una amplia selección de 
             departamentos modernos y bien equipados. Ubicados estratégicamente cerca 
             de las principales universidades y centros de estudio. </p>
            <span className="text-white mt-10 font-bold text-lg cursor-pointer transition-all hover:scale-110">Conócenos <span className="text-xl ml-3">&#10157;</span></span>
        </article>
      ...
      <section className="py-20 flex flex-col items-center gap-6">
        ...
        <p className=" text-white">Regístrate y explora las habitaciones y departamentos cerca de tu institución</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
          
          {
            ...
            habitaciones.map((habitacion) => (
              <img className=" h-52 w-80 object-cover rounded-xl" src={`${habitacion?.imagen1}`}/>
            ))
          }
        </div>
