  ...
  return (
    <main className="">
      ...
      <div className="flex justify-around my-10 items-center">
        ...
        className="p-2 border rounded w-[300px]" name="estado" id="estado"
        value={filtroEstado}
        >
      ...
      <section className={`animate-entrada grid md:grid-cols-2 ${habitaciones.length === 0 ? '' : 'xl:grid-cols-3'} gap-10 md:mx-10 xl:mx-52`}>
        {habitaciones.length === 0
          ...
          habitaciones.length > 0 && buscar.length === 0  && filtroEstado.includes('todos') ?
          ...
          : buscar.length > 0 && filtroEstado.includes('todos') ? habitacionesFiltradas.map(room =>(
            <Habitacion
