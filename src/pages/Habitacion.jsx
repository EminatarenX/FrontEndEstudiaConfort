  ...
  return (
    ...
    <div className="flex flex-col xl:flex-row-reverse p-10 gap-10 ">
      ...
      <div className="flex flex-col gap-2 text-white ">
        ...
        <button className="mt-10  rounded lg:w-40 bg-sky-900 text-center py-4 hover:bg-sky-600 hover:-translate-y-3 text-xl transition-all">{habitacion.renta === 'pendiente' ? "Pagar": "Pagado"}</button>
      </div>
