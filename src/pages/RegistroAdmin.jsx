...
export default function RegistroAdmin() {
    ...
    const registrarAdmin = async (e) => {
        ...
        try {
            ...
            Swal.fire({
                icon: 'success',
                title: `Hemos enviado un correo para la confirmacion de tu cuenta`
            ...
            <section className="flex flex-col items-center gap-10 px-10 xl:px-2 animate-entrada">
                ...
                <form
                    ...
                    <div className="flex flex-col">
                        ...
                        <label htmlFor="nombre" className="text-white text-xs font-semibold">
                            Nombre Completo
                        </label>
                        <input
                    ...
                    <div className="flex flex-col">
                        ...
                        <label htmlFor="correo" className="text-white text-xs font-semibold">
                            Correo Electronico
                        </label>
                        <input
                            className='p-3 text-xs rounded focus:outline-sky-400'
                    ...
                    <div className="flex flex-col">
                        ...
                        <label htmlFor="repetir" className="text-white text-xs font-semibold">
                            Repetir Contraseña
                        </label>
                        <input
                            className='p-3 text-xs rounded focus:outline-sky-400'
                            type="password" id="repetir"
