...
export default function HabitacionSeleccionada() {
    ...
    const send = async () => {
        ...
        const { isConfirmed } = await Swal.fire({
            text: "Deseas mandar una solicitud para rentar esta habitacion?",
            icon: 'warning',
            iconColor: '#1088ca',
        ...
        enviarSolicitud({ id_creador: habitacionSeleccionada.id_creador, id_habitacion: habitacionSeleccionada.id })
                ...
                {cargandoImagenes ? (
                    ...
                    <>
                        ...
                        <div className="flex flex-col mt-10 xl:mt-0">
                            ...
                            <button onClick={send} className="p-4 mt-2 xl:w-[250px]  bg-blue-950 rounded text-white font-semibold flex items-center justify-center gap-6">Enviar solicitud <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24">
